...
CREATE TABLE [sandwich] ([id] int identity(1,1) not null primary key, [name] varchar not null, [price] int not null);

CREATE TABLE [publisher2] ([id] int identity(1,1) not null primary key, [name] varchar not null, [type] nvarchar(100) not null, [type2] nvarchar(100) not null, [enum1] int null, [enum2] int null, [enum3] int null, [enum4] nvarchar(100) null);

CREATE TABLE [label2] ([uuid] uniqueidentifier not null, [name] varchar not null, CONSTRAINT [label2_pkey] PRIMARY KEY ([uuid]));

CREATE TABLE [foo_baz2] ([id] int identity(1,1) not null primary key, [name] varchar not null, [version] datetime not null default current_timestamp);

CREATE TABLE [foo_bar2] ([id] int identity(1,1) not null primary key, [name] varchar not null, [baz_id] int null, [foo_bar_id] int null, [version] datetime not null default current_timestamp, [blob] binary null, [array] text null, [object] text null);
CREATE INDEX [foo_bar2_baz_id_index] ON [foo_bar2] ([baz_id]);
CREATE UNIQUE INDEX [foo_bar2_baz_id_unique] ON [foo_bar2] ([baz_id]) WHERE [baz_id] IS NOT NULL;
CREATE INDEX [foo_bar2_foo_bar_id_index] ON [foo_bar2] ([foo_bar_id]);
CREATE UNIQUE INDEX [foo_bar2_foo_bar_id_unique] ON [foo_bar2] ([foo_bar_id]) WHERE [foo_bar_id] IS NOT NULL;

CREATE TABLE [foo_param2] ([bar_id] int not null, [baz_id] int not null, [value] varchar not null, CONSTRAINT [foo_param2_pkey] PRIMARY KEY ([bar_id], [baz_id]));
...
CREATE TABLE [car2] ([name] varchar not null, [year] int not null, [price] int not null, CONSTRAINT [car2_pkey] PRIMARY KEY ([name], [year]));
CREATE INDEX [car2_name_index] ON [car2] ([name]);
CREATE INDEX [car2_year_index] ON [car2] ([year]);

CREATE TABLE [car_owner2] ([id] int identity(1,1) not null primary key, [name] varchar not null, [car_name] varchar not null, [car_year] int not null);
CREATE INDEX [car_owner2_car_name_car_year_index] ON [car_owner2] ([car_name], [car_year]);

CREATE TABLE [user2] ([first_name] varchar not null, [last_name] varchar not null, [foo] int null, [favourite_car_name] varchar null, [favourite_car_year] int null, CONSTRAINT [user2_pkey] PRIMARY KEY ([first_name], [last_name]));
...
CREATE INDEX [user2_favourite_car_name_favourite_car_year_index] ON [user2] ([favourite_car_name], [favourite_car_year]);

CREATE TABLE [user2_sandwiches] ([user2_first_name] varchar not null, [user2_last_name] varchar not null, [sandwich_id] int not null, CONSTRAINT [user2_sandwiches_pkey] PRIMARY KEY ([user2_first_name], [user2_last_name], [sandwich_id]));
CREATE INDEX [user2_sandwiches_sandwich_id_index] ON [user2_sandwiches] ([sandwich_id]);
CREATE INDEX [user2_sandwiches_user2_first_name_user2_last_name_index] ON [user2_sandwiches] ([user2_first_name], [user2_last_name]);

CREATE TABLE [user2_cars] ([user2_first_name] varchar not null, [user2_last_name] varchar not null, [car2_name] varchar not null, [car2_year] int not null, CONSTRAINT [user2_cars_pkey] PRIMARY KEY ([user2_first_name], [user2_last_name], [car2_name], [car2_year]));
CREATE INDEX [user2_cars_user2_first_name_user2_last_name_index] ON [user2_cars] ([user2_first_name], [user2_last_name]);
CREATE INDEX [user2_cars_car2_name_car2_year_index] ON [user2_cars] ([car2_name], [car2_year]);

CREATE TABLE [book_tag2] ([id] bigint identity(1,1) not null primary key, [name] varchar not null);

CREATE TABLE [base_user2] ([id] int identity(1,1) not null primary key, [first_name] varchar not null, [last_name] varchar not null, [type] nvarchar(100) not null, [owner_prop] varchar null, [favourite_employee_id] int null, [favourite_manager_id] int null, [employee_prop] int null, [manager_prop] varchar null);
CREATE INDEX [base_user2_type_index] ON [base_user2] ([type]);
CREATE INDEX [base_user2_favourite_employee_id_index] ON [base_user2] ([favourite_employee_id]);
CREATE INDEX [base_user2_favourite_manager_id_index] ON [base_user2] ([favourite_manager_id]);
...
CREATE TABLE [author2] ([id] int identity(1,1) not null primary key, [created_at] datetime not null default current_timestamp, [updated_at] datetime not null default current_timestamp, [name] varchar not null, [email] varchar not null, [age] int null default null, [terms_accepted] bit not null default 0, [optional] bit null, [identities] text null, [born] date null, [born_time] time null, [favourite_book_uuid_pk] varchar null, [favourite_author_id] int null);
...
CREATE INDEX [author2_favourite_book_uuid_pk_index] ON [author2] ([favourite_book_uuid_pk]);
CREATE INDEX [author2_favourite_author_id_index] ON [author2] ([favourite_author_id]);
...
CREATE TABLE [book2] ([uuid_pk] varchar not null, [created_at] datetime not null default current_timestamp, [title] varchar null default '', [perex] text null, [price] float(24) null, [double] float(53) null, [meta] text null, [author_id] int not null, [publisher_id] int null, CONSTRAINT [book2_pkey] PRIMARY KEY ([uuid_pk]));
CREATE INDEX [book2_author_id_index] ON [book2] ([author_id]);
CREATE INDEX [book2_publisher_id_index] ON [book2] ([publisher_id]);

CREATE TABLE [test2] ([id] int identity(1,1) not null primary key, [name] varchar null, [book_uuid_pk] varchar null, [version] int not null default 1);
CREATE INDEX [test2_book_uuid_pk_index] ON [test2] ([book_uuid_pk]);
CREATE UNIQUE INDEX [test2_book_uuid_pk_unique] ON [test2] ([book_uuid_pk]) WHERE [book_uuid_pk] IS NOT NULL;

CREATE TABLE [configuration2] ([property] varchar not null, [test_id] int not null, [value] varchar not null, CONSTRAINT [configuration2_pkey] PRIMARY KEY ([property], [test_id]));
...
CREATE INDEX [publisher2_tests_publisher2_id_index] ON [publisher2_tests] ([publisher2_id]);
CREATE INDEX [publisher2_tests_test2_id_index] ON [publisher2_tests] ([test2_id]);

CREATE TABLE [book2_tags] ([order] int identity(1,1) not null primary key, [book2_uuid_pk] varchar not null, [book_tag2_id] bigint not null);
CREATE INDEX [book2_tags_book2_uuid_pk_index] ON [book2_tags] ([book2_uuid_pk]);
CREATE INDEX [book2_tags_book_tag2_id_index] ON [book2_tags] ([book_tag2_id]);

CREATE TABLE [book_to_tag_unordered] ([book2_uuid_pk] varchar not null, [book_tag2_id] bigint not null, CONSTRAINT [book_to_tag_unordered_pkey] PRIMARY KEY ([book2_uuid_pk], [book_tag2_id]));
CREATE INDEX [book_to_tag_unordered_book2_uuid_pk_index] ON [book_to_tag_unordered] ([book2_uuid_pk]);
CREATE INDEX [book_to_tag_unordered_book_tag2_id_index] ON [book_to_tag_unordered] ([book_tag2_id]);
...
CREATE INDEX [author_to_friend_author2_1_id_index] ON [author_to_friend] ([author2_1_id]);
CREATE INDEX [author_to_friend_author2_2_id_index] ON [author_to_friend] ([author2_2_id]);
...
CREATE INDEX [author2_following_author2_1_id_index] ON [author2_following] ([author2_1_id]);
CREATE INDEX [author2_following_author2_2_id_index] ON [author2_following] ([author2_2_id]);

CREATE TABLE [address2] ([author_id] int not null, [value] varchar not null, CONSTRAINT [address2_pkey] PRIMARY KEY ([author_id]));
CREATE INDEX [address2_author_id_index] ON [address2] ([author_id]);
